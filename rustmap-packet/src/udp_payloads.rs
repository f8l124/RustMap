...
const DNS_QUERY: &[u8] = &[
    ...
    0x07, b'v', b'e', b'r', b's', b'i', b'o', b'n', 0x04, b'b', b'i', b'n', b'd', 0x00, 0x00,
    0x10, // Type: TXT
...
const SNMP_GETREQUEST: &[u8] = &[
    ...
    0x06, 0x05, 0x2b, 0x06, 0x01, 0x02,
    0x01, // OID: 1.3.6.1.2.1 (iso.org.dod.internet.mgmt.mib-2)
...
const NBSTAT_REQUEST: &[u8] = &[
    ...
    0x41, 0x00, 0x00, 0x21, // Type: NBSTAT
    0x00, 0x01, // Class: IN
];
...
const MDNS_QUERY: &[u8] = &[
    ...
    b's', b'd', 0x04, b'_', b'u', b'd', b'p', 0x05, b'l', b'o', b'c', b'a', b'l', 0x00, 0x00,
    0x0c, // Type: PTR
    0x00, 0x01, // Class: IN
];
